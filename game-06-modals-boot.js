...
const CLASSES = {
    ...
    Barbarian: { name: 'Barbarian', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.' },
    Mercenary: { name: 'Mercenary', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.' },
    Ranger: { name: 'Ranger', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.' },
    Acolyte: { name: 'Acolyte', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.' },

    // === TIER 3: STRONG (Endless Mode ONLY) ===
    Paladin: { name: 'Paladin', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.', endless: true },
    Spellblade: { name: 'Spellblade', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.', endless: true },
    Assassin: { name: 'Assassin', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.', endless: true },
    Dragoon: { name: 'Dragoon', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.', endless: true },

    // === TIER 4: NEXT TO GOD-LIKE (Endless Mode ONLY) ===
    Warlord: { name: 'Warlord', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.', endless: true },
    Archmage: { name: 'Archmage', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.', endless: true },
    Phantom: { name: 'Phantom', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.', endless: true },
    Vampire: { name: 'Vampire', desc: 'Not available in demo', req: 'demo_lock', val: 9999, msg: 'Not available in demo.', endless: true }

};

const SOUL_UPGRADES = {
    vitality: { name: 'Vitality', desc: '+10 Max HP per level.', max: 3, cost: 25 },
    wisdom: { name: 'Wisdom', desc: '+10 Max MP per level.', max: 3, cost: 25 },
    endurance: { name: 'Endurance', desc: '+10 Max Stamina per level.', max: 3, cost: 25 },
    ...
    greed: { name: 'Greed', desc: 'Start with +25 Gold per level.', max: 1, cost: 50 }
};
